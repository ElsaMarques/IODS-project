...
setwd('/Users/marques/Documents/GitHub/IODS-project/data')
read_csv("human_.csv")
```
...
```
 ...
 - The brief overview on this data shows that the data "human_" created during the data wrangling exercise comprises 155 observations spread into 8 variables. Those include the amount of Female and Male that have an Higher Education; also the Female and Male amount of people that are include din laboral life; 
