...
corrplot(cor_matrix, method = "color", tl.col = "red", tl.srt = 45)

```

- Calculating the correlation matrix one can notice that most of the variables are not correlated in any way, and the ones that are show are positevely correlated. This is the case of GNI and Edu.Exp (correlation coefficient of 0.55), GNI and Life.Exp (0.57), Life.Edu and Edu.Exp (0.71)
